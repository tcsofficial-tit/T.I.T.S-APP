...
class PlacementPage extends StatefulWidget {
  PlacementPage({required this.title});
  final String title;
  @override
  _MyHomePageStatePlace createState() => _MyHomePageStatePlace();
}

class _MyHomePageStatePlace extends State<PlacementPage> {
                  ...
                  child: Row(children: [
                    Container(
                      ...
                      child: ClipRRect(
                        ...
                        child: Image.asset(
                            'assets/place/${company[index].image}',
                            fit: BoxFit.fill),
                      ),
                    ),
                    Expanded(
...
class ListClass {
  ...
  String image;
  String url;
  ListClass({required this.text, required this.image, required this.url});
}
...
List<ListClass> company = [
  ListClass(
    ...
    image: 'daffodilsw.png',
    url: 'https://www.daffodilsw.com/career',
  ),
  ListClass(
      text:
  ...
  ListClass(
      ...
      image: 'claritus.png',
      url: 'https://www.claritusconsulting.com/'),
];
